...
if (isset($_POST['user_email']) && isset($_POST['user_password'])
	...
	// else{
      ...
      //  $pass = md5($pass);
	    ...
	    //     exit();
		// }else {
           $sql2= "update user set user_email=$user_email,user_name=$user_name,user_password=$user_password,user_DOB=$DOB where user_email=$id";
           ...
           if ($result2) {
	         ...
	         exit();
	           	...
	           	header("Location: update.php.php?error=unknown error occurred&$user_data");
		        exit();
           }
		}
	//}
